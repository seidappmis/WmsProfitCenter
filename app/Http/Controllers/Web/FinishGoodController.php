...
class FinishGoodController extends Controller
{
	...
	public function searchDeliveryTicket(Request $request)
	{
		...
		$internalData = $this->searchLogDeliveryTicket($request);

		if (isset($rsData)) {
			return array_merge($rsData, $internalData);
		}else{
			return $internalData;
		}
	...
	public function searchLogDeliveryTicket(Request $request)
	{
		$sql = FinishGoodTicket::query()
			->select([
				'log_finish_good_ticket.ticket_no as HEADER_NAME',
				'log_finish_good_ticket.qty as quantity',
