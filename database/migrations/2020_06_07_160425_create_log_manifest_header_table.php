...
class CreateLogManifestHeaderTable extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  public function up()
  {
    Schema::create('log_manifest_header', function (Blueprint $table) {
      ...
      $table->datetime('do_manifest_time');
      ...
      $table->datetime('r_create_date')->nullable();
      $table->string('r_create_by', 50)->nullable();
      $table->timestamps();
  ...
  {
    Schema::dropIfExists('log_manifest_header');
  }
}
