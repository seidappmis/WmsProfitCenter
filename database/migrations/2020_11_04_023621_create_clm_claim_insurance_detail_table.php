...
class CreateClmClaimInsuranceDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clm_claim_insurance_detail', function (Blueprint $table) {
            $table->id();

            $table->integer('claim_insurance_id')->length(20)->nullable();
    ...
    {
        Schema::dropIfExists('clm_claim_insurance_detail');
    }
}
