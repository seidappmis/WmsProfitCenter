    ...
    <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark no-shadow">
      <div class="nav-wrapper">
        ...
        <ul class="navbar-list right">
          ...
          <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ url('materialize/images/avatar/avatar-7.png') }}" alt="avatar"><i></i></span></a></li>
        </ul>
        ...
        <ul class="dropdown-content" id="profile-dropdown">
          ...
          <li><a class="grey-text text-darken-1" href="#"><i class="material-icons">vpn_key</i> Ganti Password</a></li>
          <li class="divider"></li>
