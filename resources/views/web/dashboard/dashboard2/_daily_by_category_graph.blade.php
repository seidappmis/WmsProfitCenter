...
$(document).ready(function() {
  Chart3 = new Highcharts.Chart({
    ...
    subtitle: { text: 'KARAWANG 2020-04-19' }, 
    ...
    series: [{ data: [{ y: 1 }, { y: 0 }, { y: 0 }, { y: 0 }, { y: 0 }], name: 'TRAILER' }, { data: [{ y: 70 }, { y: 0 }, { y: 3 }, { y: 1 }, { y: 7 }], name: 'TRONTON' }, { data: [{ y: 23 }, { y: 0 }, { y: 5 }, { y: 1 }, { y: 1 }], name: 'CONTAINER' }, { data: [{ y: 1 }, { y: 0 }, { y: 0 }, { y: 0 }, { y: 0 }], name: 'WINGBOX' }, { data: [{ y: 4 }, { y: 0 }, { y: 0 }, { y: 0 }, { y: 3 }], name: 'LIGHT TRUCK' }, { data: [{ y: 42 }, { y: 0 }, { y: 0 }, { y: 0 }, { y: 1 }], name: 'SMALL TRUCK' }]
  });
});
</script>
@endpush