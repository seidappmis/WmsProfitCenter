...
<body style="font-family: courier New; font-size: 10pt;">
  <table style="font-family: Arial;border-collapse: collapse; border-bottom: 2px solid; margin-bottom: 20px;">
    <tr>
      <td><img src="{{ __DIR__ . '/../../../public/images/msig-logo.png' }}"/></td>
      <td>
  ...
  <table style="font-family: Arial;border-collapse: collapse;">
    ...
    <tr>
      ...
      <td <?php /* width="20px" */ ?> style="border-top: 1px solid black;">:</td>
      <td colspan="7" style="border-top: 1px solid black;">{{ $marineCargo->insurance_policy_no }}</td>
      <td rowspan="13" <?php /* width="200px" */ ?> style="border: 1px solid black;">
        Enclosures (Mark O)
        <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Policy Original
        <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Invoice
        <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Packing List
    ...
    <tr>
      ...
      <td <?php /* width="20px" */ ?> style="border-bottom: 1px solid black;">:</td>
    ...
    @foreach ($cartonBoxs as $value)
      ...
      <tr>
        ...
        <td <?php /* width="5px" */ ?>>=</td>
        <td style="text-align: right;" <?php /* width="120px" */ ?>>IDR {{ thousand_reformat($value['price_carton_box']) }}</td>
        <td style="text-align: center;" <?php /* width="50px" */ ?>>X</td>
        <td style="text-align: center;" <?php /* width="50px" */ ?>>{{ $value['qty'] }}</td>
        <?php $totalQty += $value['qty'] ?? 1; ?>
        <td>&nbsp;</td>
        <td style="text-align: left;">=</td>
        <td colspan="2" <?php /* width="120px" */ ?> style="text-align: right;">IDR
    ...
    <tr>
      <td <?php /* width="5px" */ ?> style="border-left: 1px solid black;"></td>
