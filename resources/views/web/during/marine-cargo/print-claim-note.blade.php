...
<body style="font-family: courier New; font-size: 10pt;">
  <table style="font-family: Arial;border-collapse: collapse;" width="100%">
   <tr><td colspan="13" style="text-align: center;"><strong><u>CLAIM NOTE</u></strong></td></tr>
   <tr><td colspan="13" style="text-align: center;"><strong>Marine Cargo</strong></td></tr>
   <tr><td colspan="13">Dear Sirs</td></tr>
   <tr><td colspan="13" style="text-align: center;">I/We send you here with my/our claim note for the undermentioned with the request that you</td></tr>
   <tr><td colspan="13" style="text-align: center;">will be kind enough to settlement of the claim at the earliest date.</td></tr>
   ...
   <tr>
      <td colspan="4" style="border-left: 1px solid black; border-bottom: 1px solid black;">Kind of Damage/Kind of Loss</td>
      <td width="20px;" style="border-bottom: 1px solid black;">:</td>
      <td colspan="7" style="border-bottom: 1px solid black;">Wet and Dented</td>
   </tr>

   <tr><td colspan="13" style="text-align: center; border-left: 1px solid black; border-right: 1px solid black;"><strong><u>CALCULATION</u></strong></td></tr>
   <tr><td colspan="13" style="text-align: center; border-left: 1px solid black; border-right: 1px solid black;"><strong>No.{{ $marineCargo->dgr->dgr_no }}</strong></td></tr>
   <tr>
      <td colspan="2" style="border-left: 1px solid black;"><strong>Invoice No</strong></td>
      <td width="20px">:</td>
      <td colspan="10" style="border-right: 1px solid black;"><strong>{{ $marineCargo->getInvoiceNo() }}</strong></td>
   </tr>
   <tr>
   ...
   <tr><td colspan="13" style="border-left: 1px solid black; border-right: 1px solid black;">&nbsp;</td></tr>
   ...
   <tr>
      ...
      <td style="border-right: 1px solid black;"><strong>Curr:</strong></td>
   </tr>
   <tr>
      <td colspan="8" style="text-align: right; border-left: 1px solid black; border-bottom: 1px solid black;"><strong>Total Claim Amount : </strong></td>
      <td colspan="4" style="border-bottom: 1px solid black;"><strong>IDR {{ thousand_reformat($totalPriceIDR) }}</strong></td>
      <td style="border-right: 1px solid black; border-bottom: 1px solid black;"><strong>USD {{ thousand_reformat($totalPriceUSD) }}</strong></td>
   </tr>

   <tr><td colspan="13" style="border-left: 1px solid black; border-right: 1px solid black;"></td></tr>
   <tr>
      <td width="5px" style="border-left: 1px solid black;"></td>
      <td colspan="7" style="border-left: 1px solid black; border-top: 1px solid black; border-right: 1px solid black;"><strong><u>Please Remit the Payment To:</u></strong></td>
      <td colspan="5" style="text-align: center; border-right: 1px solid black;">Karawang, {{ date('F d, Y', strtotime($marineCargo->dgr->created_at)) }}<td>
   </tr>
   <tr>
      <td width="5px" style="border-left: 1px solid black;"></td>
      ...
      <td colspan="5" style="text-align: center; border-right: 1px solid black;">Yours faithfully<td>
   </tr>
   <tr>
      <td width="5px" style="border-left: 1px solid black;"></td>
      ...
      <td colspan="5" style="text-align: center; border-right: 1px solid black;">&nbsp;<td>
   </tr>
   <tr>
      <td width="5px" style="border-left: 1px solid black;"></td>
   ...
   <tr>
      ...
      <td colspan="5" style="text-align: center; border-right: 1px solid black;"><u>Mr. E. Gunandi</u><td>
   </tr>
   <tr>
      <td width="5px" style="border-left: 1px solid black;"></td>
      <td style="border-left: 1px solid black; border-bottom: 1px solid black;">Beneficary</td>
      <td style="border-bottom: 1px solid black;">:</td>
      <td colspan="5" style="border-right: 1px solid black; border-bottom: 1px solid black;">PT. SHARP ELECTRONIC INDONESIA</td>
      <td colspan="5" style="text-align: center; border-right: 1px solid black;">Authorized Signature<td>
   </tr>
   <tr><td colspan="13" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;"></td></tr>
