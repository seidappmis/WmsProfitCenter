<html>
<head><link rel="stylesheet" type="text/css" href="{{ url('materialize/css/custom/print1-hq.css') }}"></head>
<body style="font-family: courier New; font-size: 10pt;">
	<table style="font-family: Arial;border-collapse: collapse; border-bottom: 2px solid; margin-bottom: 20px;" width="100%">
		<tr>
			<td width="10%"><img src="{{URL::to('/images/msig-logo.png')}}" width="100%" /></td>
			<td>
				<div style="text-align: center;"><strong>PT. Asuransi MSIG Indonesia</strong></div>
				<div style="text-align: center;">Summitmas II Building, 15<sup>th</sup> Floor, Jl. Jend. Sudirman Kav. 61-62, Jakarta 12190</div>
	...
	<table style="font-family: Arial;border-collapse: collapse;" width="100%">
		...
		<tr>
			<td colspan="13" style="text-align: center;">I/We send you here with my/our claim note for the undermentioned with the request that you</td>
		</tr>
		<tr>
			<td colspan="13" style="text-align: center;">will be kind enough to settlement of the claim at the earliest date.</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="13" style="text-align: center; border-left: 1px solid black; border-right: 1px solid black;"><strong><u>CALCULATION</u></strong></td>
		</tr>
		<tr>
			<td colspan="13" style="text-align: center; border-left: 1px solid black; border-right: 1px solid black;"><strong>No.{{ $marineCargo->dgr->dgr_no }}</strong></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<?php $totalQty += $value['qty'] ?? 1; ?>
			<td>=</td>
			<td style="text-align: right;">USD {{ thousand_reformat($value['qty'] * $value['price'] * 110 / 100) }}</td>
			<td style="border-right: 1px solid black;"></td>
		</tr>
		@endforeach
		@if(!empty($units))
		...
		<tr>
			...
			<td colspan="5" style="text-align: center; border-right: 1px solid black;">Karawang, {{ date('F d, Y', strtotime($marineCargo->dgr->created_at)) }}
			<td>
		</tr>
		<tr>
			<td width="5px" style="border-left: 1px solid black;"></td>
		...
		<tr>
			<td colspan="13" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;"></td>
		</tr>
