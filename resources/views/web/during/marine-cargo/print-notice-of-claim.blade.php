...
<body style="font-family: courier New; font-size: 9pt;">
  <table style="font-family: Arial;border-collapse: collapse;" width="100%">
   ...
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr>
      <td width="10px"><strong>To.</strong></td>
   ...
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">Name of Vessel</td><td style="width: 15px;">:</td><td>{{ $marineCargo->vessel_name }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">Sailed On, {{ date('M d, Y', strtotime($marineCargo->sailed_date)) }}</td><td style="width: 15px;">:</td><td>{{ $marineCargo->sailed_on }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">Eta, Tanjung Priuk, Jakarta</td><td style="width: 15px;">:</td><td>{{ date('F d, Y', strtotime($marineCargo->arrived_date)) }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">Receiving goods at our Warehouse</td><td style="width: 15px;">:</td><td>{{ date('F d, Y', strtotime($marineCargo->discharging_date)) }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">B/L No</td><td style="width: 15px;">:</td><td>{{ $marineCargo->getBLNo() }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">Invoice No</td><td style="width: 15px;">:</td><td>{{ $marineCargo->getInvoiceNo() }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
   <tr><td colspan="2" style="width: 20%;">Nature of Claim</td><td style="width: 15px;">:</td><td>{{ $marineCargo->getNatureOfClaim() }}</td><td></td></tr>
   <tr><td colspan="5">&nbsp;</td></tr>
