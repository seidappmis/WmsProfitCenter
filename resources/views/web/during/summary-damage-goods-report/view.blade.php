        ...
        <div class="section">
          <div class="card">
            <div class="card-content">
              ...
              <a class="waves-effect waves-light btn btn-small indigo darken-4 mt-2"
                href="{{ url('summary-damage-goods-report') }}">Back</a>
            </div>
          </div>
        </div>
      </div>
    ...
    jQuery(document).ready(function() {
      ...
      dtSummary = $('#table-summary').DataTable({
        ...
        columns: [{
          ...
          render: function(data, type, row, meta) {
            val =
              '<div style="width:200px;padding-left:10px;padding-right:10px;" class="center-align"><input type="text" class="claim" value="' +
              (data ? data : '') + '" readonly></div>';
            return val;
          }
        }, {
          data: 'damage',
          ...
          render: function(data, type, row, meta) {
            val =
              '<textarea class="damage materialize-textarea" placeholder="Remarks" style="width:300px;height:100px;resize: vertical;" data-id="' +
              row.claim_note_detail + '">' + (data ? data : '') + '</textarea>';
            return val;
          }
        }],
