  ...
  jQuery(document).ready(function($) {
    ...
    dttable_list_manifest_receipt = $('#table_list_manifest_receipt').DataTable({
        ...
        columns: [
            ...
            {data: 'city_name'},
            {data: 'count_of_do'},
            {data: 'cbm_do', className: 'right-align'},
            {data: 'cbm_amount', className: 'right-align'},
            {data: 'ritase_amount', className: 'right-align'},
            {data: 'ritase2_amount', className: 'right-align'},
            {data: 'multidro_amount', className: 'right-align'},
            {data: 'unloading_amount', className: 'right-align'},
            {data: 'overstay_amount', className: 'right-align'},
