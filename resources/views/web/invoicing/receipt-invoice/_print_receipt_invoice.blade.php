	...
	<table style="border-collapse: collapse; font-size: 5pt;">
		...
		<thead>
			...
			<tr>
				...
				<td colspan="2" style="text-align: center; vertical-align: top; font-size: 5pt;width: 1.6cm;border: 1pt solid black;">
					<strong>NO MANIFEST</strong>
				</td>
				<td colspan="1" style="text-align: center; vertical-align: top; font-size: 5pt;width: 1.4cm;border: 1pt solid black;">
					<strong>TANGGAL</strong>
				</td>
				<td colspan="2" style="text-align: center; vertical-align: top; font-size: 5pt;width: 1.6cm;border: 1pt solid black;">
					<strong>TUJUAN</strong>
				</td>
				<td colspan="2" style="text-align: center; vertical-align: top; font-size: 5pt;width: 1.45cm;border: 1pt solid black;">
					<strong>KENDARAAN</strong>
				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt;width: 1.4cm;border: 1pt solid black;">
					<strong>NO POLISI</strong>
				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt;width: 1.3cm;border: 1pt solid black;">
				...
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 2cm;border: 1pt solid black;">
					<strong>NO DO SAP</strong>
				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 1.15m;border: 1pt solid black;">
					<strong>TGL DO SAP</strong>

				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 1.2cm;border: 1pt solid black;">
					<strong>SHIP TO</strong>

				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 3.5cm;border: 1pt solid black;">
					<strong>SHIP TO DETAIL</strong>

				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 1.7cm;border: 1pt solid black;">
					<strong>ACC CODE</strong>

				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 1.8cm;border: 1pt solid black;">
					<strong>MODEL</strong>

				</td>
				<td style="text-align: center; vertical-align: top; font-size: 5pt; width: 0.8cm;border: 1pt solid black;">
					<strong>QTY</strong>
		...
		<tbody>
			...
			@foreach( $printData['list'] AS $kManifest => $vManifest)
				...
				@endphp
				<tr>
					<td style="text-align: center; font-size: 5pt; border: 1pt solid black; border-bottom:none; width: 1.5cm;">
						{{$noUrutManifest++}}.
					</td>
					<td colspan="2" style="text-align: left; font-size: 5pt; border: 1pt solid black; border-bottom:none; width: 1.5cm; padding: 2pt;">
						{{$vManifest['do_manifest_no']}}
					</td>
					<td style="text-align: center; font-size: 5pt; border: 1pt solid black; border-bottom:none; width: 1.5cm; padding: 2pt;">
					...
					<td style="text-align: left; font-size: 5pt; border: 1pt solid black; border-bottom:none; width: 1.5cm; padding: 2pt;">
						{{ $vManifest['vehicle_number'] }}
					</td>
					<td style="text-align: right; font-size: 5pt; border: 1pt solid black; border-bottom:none; width: 1.5cm; padding: 2pt;">
				...
				@endif				
				<tr>
					<td style="text-align: center; font-size: 5pt; border: 1pt solid black; border-top:none; width: 1.5cm; padding: 2pt;"></td>
					<td colspan="2" style="border: 1pt solid black; border-top:none; width: 1.5cm"></td>
					<td style="border: 1pt solid black; border-top:none; width: 1.5cm"></td>
					<td colspan="2" style="border: 1pt solid black; border-top:none; width: 1.5cm"></td>
					<td colspan="2" style="border: 1pt solid black; border-top:none; width: 1.5cm"></td>
					<td style="border: 1pt solid black; border-top:none; width: 1.5cm"></td>
					<td style="border: 1pt solid black; border-top:none; width: 1.5cm"></td>
					...
					<td colspan="6" style="text-align: right; font-size: 5pt;border: 1pt solid black; padding: 2pt;">
	...
	<table style="page-break-inside: avoid; border-collapse: collapse; font-size: 5pt; margin-top: 10px;">
		<tbody>
			...
			<tr>
				...
				@if($printData['summary']['BR'])
				<td style="text-align: center;border: 1pt solid black; font-size: 5pt; width: 1.5cm; padding: 2pt;">FREIGHT COST
				</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 5pt; width: 1.5cm; padding: 2pt;">MULTIDROP
				</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 5pt; width: 1.5cm; padding: 2pt;">UNLOADING
				</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 5pt; width: 1.5cm; padding: 2pt;">OVERSTAY
				</td>
				@endif
				@if($printData['summary']['DS'])
				<td style="text-align: center;border: 1pt solid black; font-size: 5pt; width: 1.5cm; padding: 2pt;">FREIGHT COST
			...
			<tr>
				...
				@if($printData['summary']['BR'])
				<td colspan="1" style="font-size: 5pt;text-align: right;border: 1pt solid black; width: 1.5cm; padding: 2pt;">
					{{!empty($value['BR']) ? thousand_reformat($value['BR']['freight_cost']) : 0}}
				</td>
				<td style="font-size: 5pt;text-align: right; border: 1pt solid black; width: 1.5cm; padding: 2pt;">
