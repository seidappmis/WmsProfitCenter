<body>
	<table width="100%">
		<thead>
			<tr>
				<td colspan="20" style="text-align: center; font-size: 16pt; vertical-align: top;">
			...
			<tr>
				...
				<td colspan="3" style="text-align: center; vertical-align: top; font-size: 8pt;width: 55px;border: 1pt solid black;">
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="3" style="text-align: left; font-size: 8pt; border: 1pt solid black; border-bottom:none; width: 57px; padding: 2pt;">
			...
			<tr>
				...
				<td colspan="2" style="border-left: 1pt solid black; border-right: 1pt solid black; width: 57px;">&nbsp;</td>
				<td colspan="3" style="border-left: 1pt solid black; border-right: 1pt solid black; width: 57px;">&nbsp;</td>
				<td style="border-left: 1pt solid black; border-right: 1pt solid black; width: 57px;">&nbsp;</td>
				<td style="border-left: 1pt solid black; border-right: 1pt solid black; width: 57px;">&nbsp;</td>
				<td style="border-left: 1pt solid black; border-right: 1pt solid black; width: 57px;">&nbsp;</td>
				<td style="border-left: 1pt solid black; border-right: 1pt solid black; width: 57px;">&nbsp;</td>
			...
			<tr>
				...
				<td colspan="2" style="border: 1pt solid black; border-top:none; width: 57px"></td>
				<td colspan="3" style="border: 1pt solid black; border-top:none; width: 57px"></td>
				<td style="border: 1pt solid black; border-top:none; width: 57px"></td>
				<td style="border: 1pt solid black; border-top:none; width: 57px"></td>
				<td style="border: 1pt solid black; border-top:none; width: 57px"></td>
				<td style="border: 1pt solid black; border-top:none; width: 57px"></td>
			...
			<tr>
				...
				<td colspan="3" style="text-align: left;border: 1pt solid black; font-size: 8pt; width: 55px; padding: 2pt;">
					Total Freight
				</td>
			...
			<tr>
				...
				<td colspan="3" style="text-align: left;border: 1pt solid black; font-size: 8pt; padding: 2pt;">Tax
				</td>
			...
			<tr>
				...
				<td colspan="3" style="text-align: left;border: 1pt solid black; font-size: 8pt; padding: 2pt;">Grand
					Total
				</td>
				<td style="text-align: right;border: 1pt solid black; font-size: 8pt; padding: 2pt;">
			...
			<tr>
				...
				<td colspan="6" style="text-align: center;border: 1pt solid black; font-size: 8pt;">BR</td>
				@endif
				@if($printData['summary']['DS'])
				<td colspan="6" style="text-align: center;border: 1pt solid black; font-size: 8pt;">DS</td>
				@endif
			...
			<tr>
				...
				@if($printData['summary']['BR'])
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">FREIGHT COST</td>
				<td colspan="2" style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">MULTIDROP</td>
				<td colspan="2" style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">UNLOADING</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">OVERSTAY</td>
				@endif
				@if($printData['summary']['DS'])
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">FREIGHT COST</td>
				<td colspan="2" style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">MULTIDROP</td>
				...
				@endif
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">FREIGHT COST</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">MULTIDROP</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">UNLOADING</td>
				<td style="text-align: center;border: 1pt solid black; font-size: 8pt; width: 57px; padding: 2pt;">OVERSTAY</td>
			...
			<tr>
				...
				<td colspan="2" style="font-size: 8pt;text-align: right; border: 1pt solid black; width: 57px; padding: 2pt;">
