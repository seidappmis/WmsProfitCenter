...
<a href="#modal-upload-return" class="waves-effect waves-light indigo btn-small btn-upload modal-trigger mb-1">Upload
  Return</a>
@include('web.outgoing.manifest-as.modal_upload_return')
      ...
      $('.btn-multi-delete-selected-item').click(function(event) {
        ...
        swal({
          ...
          if (confirm) { // Bila oke post ajax ke url delete nya
            // Ajax Post Delete
            $.ajax({
                url: '{{ url('manifest-as/delete-selected-do') }}',
                type: 'DELETE',
