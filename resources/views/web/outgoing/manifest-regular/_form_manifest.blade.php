		...
		<tr>
			...
			<td width="30%">
				<div class="input-field col s8">
					<input type="text" class="validate" name="do_manifest_no" value="{{!empty($manifestHeader) ? $manifestHeader->do_manifest_no : ''}}" readonly />
				</div>
			...
			<td width="30%">
				<div class="input-field col s12">
					<input type="text" class="validate" name="do_manifest_date" value="{{!empty($manifestHeader) ? $manifestHeader->do_manifest_date : date('Y-m-d', strtotime('-7 hours'))}}" readonly />
				</div>
			</td>
		</tr>
		<tr>
			...
			<td width="30%">
				<div class="input-field col s12">
					...
					<input type="text" class="validate" name="expedition_name" value="{{!empty($manifestHeader) ? $manifestHeader->expedition_name : $lmbHeader->expedition_name}}" readonly />
				</div>
			</td>
		</tr>
		<tr>
			...
			<td width="30%">
				<div class="input-field col s12">
					...
					<input type="text" class="validate" name="driver_name" value="{{!empty($manifestHeader) ? $manifestHeader->driver_name : $lmbHeader->driver_name}}" readonly />
				</div>
			</td>
			<td width="20%">Vehicle Type</td>
			<td width="30%">
				<div class="input-field col s12">
					<input type="hidden" class="validate" name="vehicle_code_type" value="{{!empty($manifestHeader) ? $manifestHeader->vehicle_code_type : $lmbHeader->picking->vehicle_code_type}}" readonly />
					<input type="text" class="validate" name="vehicle_description" value="{{!empty($manifestHeader) ? $manifestHeader->vehicle_description : $lmbHeader->picking->vehicle->vehicle_description}}" readonly />
				</div>
			</td>
		</tr>
		<tr>
			...
			<td width="30%">
				<div class="input-field col s12">
					<input type="hidden" class="validate" name="destination_number_driver" value="{{$lmbHeader->destination_number}}" readonly />
					<input type="text" class="validate" name="destination_name_driver" value="{{$lmbHeader->destination_name}}" readonly />
			...
			<td width="30%">
				<div class="input-field col s12">
					<input type="text" class="validate" name="container_no" value="{{!empty($manifestHeader) ? $manifestHeader->container_no : $lmbHeader->container_no}}" />
				</div>
			</td>
		</tr>
		<tr>
			...
			<td width="30%">
				<div class="input-field col s12">
					<input type="text" class="validate" name="seal_no" value="{{!empty($manifestHeader) ? $manifestHeader->seal_no : $lmbHeader->seal_no}}" />
				</div>
			</td>
			<td width="20%">Checker</td>
			<td width="30%">
				<div class="input-field col s12">
					<input type="text" class="validate" name="checker" value="{{!empty($manifestHeader->checker) ? $manifestHeader->checker : ''}}" />
				</div>
			</td>
		</tr>
		<tr>
