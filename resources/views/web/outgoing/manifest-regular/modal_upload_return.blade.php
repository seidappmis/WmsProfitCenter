@push('page-modal')
<!-- Modal Structure -->
<div id="modal-upload-return" class="modal">
<form id="form-upload-return">
  <div class="modal-content">
    <h4>Upload DO</h4>
    <table class="form-table">
      <tr>
        <td width="120px">Upload Type</td>
        <td>Return <input type="hidden" name="type" value="return"> </td>
      </tr>
      <tr>
...
<script type="text/javascript">
  jQuery(document).ready(function($) {
    $('#form-upload-return [name="ship_to"]').select2({
    ...
    $('#form-upload-return [name="ship_to"]').change(function(event) {
      /* Act on the event */
      var data = $(this).select2('data')[0]
      $('#form-upload-return [name="city_name"]').val(data.text)
    });

    $("#form-upload-return").validate({
        submitHandler: function(form) {
          ...
          .done(function(data) { // selesai dan berhasil
            data_concept = data;
            $(form)[0].reset();
             $('#modal-upload-return').modal('close');
