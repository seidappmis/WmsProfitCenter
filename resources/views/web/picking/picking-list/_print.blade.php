...
<body style="font-family: courier New; font-size: 10pt">
   ...
   <htmlpagefooter name="myFooter1">
      <table width="100%">
         <tr>
            <td style="border-top: 1pt solid #000000;" colspan="7">&nbsp;</td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="5"></td>
            <td style="text-align: center;">{{!empty($pickinglistHeader->createdBy) ? $pickinglistHeader->createdBy->username : ''}}</td>
   ...
   <table width="100%">
      <thead>
         {{-- Judul Tabel --}}
         <tr>
            <td colspan="7" style="border-bottom: 1pt solid #000000;">&nbsp;</td>
         </tr>
         <tr>
