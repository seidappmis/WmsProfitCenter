      ...
      <table style="width: 210.0003mm;">
        <tr>
          <td>
            <table width="100%" style="font-size: 9pt;">
              ...
              <tr>
                <td colspan="15" style="text-align: center; font-size: 14pt;"><strong>LAPORAN MUATAN BARANG</strong></td>
              </tr>
              <tr>
        ...
        <tr>
          <td>
            ...
            <table width="100%" style="border-collapse: collapse; font-size: 9pt;">
              ...
              <tr>
                <td style="text-align: center; border-bottom: 1pt solid #000000;" colspan="3">581910101</td>
                <td style="text-align: center; border-bottom: 1pt solid #000000;" colspan="3">581910101</td>
        ...
        <tr>
          <td>
            <table width="100%" style="font-size: 9pt;">
              <tr>
                <td rowspan="3" colspan="4" style="font-style: italic; width: 105mm; word-wrap: break-word;">
                  Pengangkut diharap memeriksa &amp; menghitung barang yang diangkut. *Claim kekurangan barang diluar areal pergudangan kami bukan menjadi tanggung jawab kami.
                </td>
                <td style="width: 5mm;"></td>
                <td colspan="2" style="text-align: center; border: 1pt solid #000000; width: 20mm;">LOADING</td>
                <td colspan="2" style="text-align: center; border: 1pt solid #000000; width: 20mm;">ST. KEEPER</td>
                <td colspan="2" style="text-align: center; border: 1pt solid #000000; width: 20mm;">CHECKER</td>
                <td colspan="2" style="text-align: center; border: 1pt solid #000000; width: 20mm;">DRIVER</td>
                <td colspan="2" style="text-align: center; border: 1pt solid #000000; width: 20mm;">DEALER</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
