                  ...
                  <tr>
                    ...
                    <td>
                      <div class="input-field col s12">
                        <div class="input-field col s12">
                          <select name="area" id="area_filter" class="select2-data-ajax browser-default">
                          </select>
                        </div>
                      </div>
                    </td>
      ...
      dttable_report_kpi_expedition = $('#table_report_kpi_expedition').DataTable({
        ...
        buttons: [{
            ...
            action: function(e, dt, node, config) {
              window.location.href = "{{ url('report-kpi-expeditions/export?filetype=pdf') }}" + '&area=' +
                $('#form-report-kpi-expedition [name="area"]').val() + '&periode=' +
                $('#form-report-kpi-expedition [name="periode"]').val();
            }
          },
          {
            text: 'EXCEL',
            action: function(e, dt, node, config) {
              window.location.href = "{{ url('report-kpi-expeditions/export?filetype=xls') }}" + '&area=' +
                $('#form-report-kpi-expedition [name="area"]').val() + '&periode=' +
                $('#form-report-kpi-expedition [name="periode"]').val();
            }
          }
